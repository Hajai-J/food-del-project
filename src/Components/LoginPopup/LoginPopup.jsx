  ...
  return (
    <div className='login-popup'>
        <form className="login-popup-container">
            ...
            {currentState === "Login" ?  <p>Create a new account? <span onClick={() => setCurrentState("Sign Up")}>Click here</span></p> : <p>Already have an acount? <span onClick={() => setCurrentState("Login")}>Login here</span></p>}
